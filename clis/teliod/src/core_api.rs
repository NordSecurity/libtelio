...
/// 2. Existing file but with missing machine_identifier, fetches it from API [Loaded] and registering it if not found [Created]
/// 3. Complete identity file, validate by updating it on API [Loaded], registering it if not found [Created]
