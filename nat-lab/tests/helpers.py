...
async def setup_environment(
    ...
    prepare_vpn: Optional[List[ConnectionTag]] = None,
    ...
    * `prepare_vpn` - List of VPN container tags to prepare for the test.
    ...
    * `prepare_vpn` - Optional list of VPN container tags to prepare (e.g. [ConnectionTag.DOCKER_VPN_1, ConnectionTag.VM_LINUX_NLX_1]).
