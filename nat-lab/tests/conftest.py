...
def collect_nordderper_logs():
    ...
    for i in range(1, num_containers + 1):
        ...
        copy_file_from_container(container_name, "/etc/nordderper/relay.log", destination_path)
...
def copy_file_from_container(container_name, src_path, dst_path):
    ...
    try:
        ...
        print(f"Log file {src_path} copied successfully from {container_name} to {dst_path}")
