...
class Client:
    ...
    async def run(
        ...
        async with AsyncExitStack() as exit_stack:
            ...
            try:
                ...
                log.info("[%s] Test cleanup: Stopping device", self._node.name)
    ...
    async def wait_for_event_peer(
        ...
        log.info("[%s] wait for event %s", self._node.name, event_info)
        ...
        log.info("[%s] got event %s", self._node.name, event_info)
