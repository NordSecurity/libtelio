...
from tests.helpers_ens import (
    ...
    ns_set_maintenance_on,
    ns_set_maintenance_off,
...
async def test_ens_server_maintenance(
    ...
    async with AsyncExitStack() as exit_stack:
        ...
        await ns_set_maintenance_off(
            nlx_conn
        )  # Ensure that server not in maintenance mode
        ...
        try:
            ...
            await ns_set_maintenance_on(nlx_conn)  # Enable maintenance mode
            ...
            await ns_set_maintenance_off(nlx_conn)  # Disable maintenance mode
