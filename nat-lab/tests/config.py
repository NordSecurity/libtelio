...
WG_SERVER = {
    "ipv4": "10.0.100.1",
    "port": 51820,
    "public_key": "4ldnOeotRBnRFF1vD4wxPvk2+lGPwocxNH/9Es7FQQU=",
}
...
DERP_PRIMARY = {
    ...
    "public_key": "Oroo/dssWHRQuSEMljlE4IkhUgCfiSRdna1kQYLmAiI=",
    "weight": 1,
    "use_plain_text": True,
}
...
DERP_FAKE = {
    ...
    "stun_port": 3479,
    "stun_plaintext_port": 3478,
    "public_key": "IGeAxAGiQKZDUaXKWQaW1COJ5DWOqRD5DwrEN0v5y2o=",
    "weight": 2,
    "use_plain_text": True,
}
...
DERP_SECONDARY = {
    ...
    "stun_port": 3479,
    "stun_plaintext_port": 3478,
    "public_key": "9bvUU4iwgPFUaSTnRf2AUDP+oI8vl+BeP03queAN6Vo=",
    "weight": 3,
    "use_plain_text": True,
}
...
DERP_TERTIARY = {
    ...
    "stun_port": 3479,
    "stun_plaintext_port": 3478,
    "public_key": "m69wmLZvOySEYwQo+jMGdsepOVX4EHEnL2PjFCSX8Tc=",
    "weight": 4,
    "use_plain_text": True,
}
...
ALPHA_NODE_ADDRESS = "100.64.33.1"
BETA_NODE_ADDRESS = "100.64.33.2"
GAMMA_NODE_ADDRESS = "100.64.33.3"
