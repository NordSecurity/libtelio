...
LAN_ADDR_MAP: Dict[ConnectionTag, Dict[str, str]] = {
    ...
    ConnectionTag.VM_MAC: {"primary": "10.55.0.12", "secondary": ""},
    ...
    ConnectionTag.DOCKER_FULLCONE_GW_1: {"primary": "192.168.109.254", "secondary": ""},
    ConnectionTag.DOCKER_FULLCONE_GW_2: {"primary": "192.168.106.254", "secondary": ""},
    ...
    ConnectionTag.DOCKER_NLX_1: {"primary": "10.0.100.51", "secondary": ""},
}
...
GW_ADDR_MAP: Dict[ConnectionTag, Dict[str, str]] = {
    ...
    ConnectionTag.VM_WINDOWS_2: {
        "primary": "192.168.153.254",
        "secondary": "192.168.154.254",
    },
}
