...
def test_telio_features():
    ...
    expected_nurse_qos = TelioFeatures.from_json(
        """{"macos_sideload": false, "exit_dns": {"auto_switch_dns_ips": true}, "nurse": {"fingerprint": "fingerprint", "qos": {"rtt_interval": 5, "rtt_tries": 3, "rtt_types": ["Ping"], "buckets": 5, "heartbeat_interval": 3600}}}"""
    )
    ...
    expected_full = TelioFeatures.from_json(
        """{"macos_sideload": true, "exit_dns": {"auto_switch_dns_ips": true}, "direct": {"providers": ["stun", "local"]}, "lana": {"prod": false, "event_path": "/"}, "nurse": {"fingerprint": "alpha", "qos": {"rtt_interval": 5, "rtt_tries": 3, "rtt_types": ["Ping"], "buckets": 5, "heartbeat_interval": 3600}}}"""
    )
