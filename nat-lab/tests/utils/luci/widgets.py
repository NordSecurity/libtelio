...
def cbi_page_action_save(page: Page) -> Locator:
    return page.locator("div.cbi-page-actions button.cbi-button-save")


def luci_notification(page: Page, text: str) -> Locator:
    return page.locator(f'div.alert-message:has-text("{text}")')
