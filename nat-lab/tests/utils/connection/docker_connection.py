...
DOCKER_SERVICE_IDS: Dict[ConnectionTag, str] = {
    ...
    ConnectionTag.DOCKER_OPENWRT_CLIENT_1: "openwrt-client-24-10",
    ConnectionTag.DOCKER_OPENWRT_CLIENT_2: "openwrt-client-25-12",
    ...
    ConnectionTag.DOCKER_OPENWRT_GW_1: "openwrt-gw-24-10",
    ConnectionTag.DOCKER_OPENWRT_GW_2: "openwrt-gw-25-12",
