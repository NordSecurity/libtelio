...
impl CrossPingCheck {
    ...
    fn compare_candidate_preference(
        ...
        // Define endpoint pair preference to be the sum
        // of individual EP preferences
...
mod tests {
    ...
    async fn test_endpoint_candidate_preference() {
        ...
        // Now we will randomly shuffle expected candidates
        // and sort using `Self::compare_candidate_preference
        let mut candidates = expected_candidates.clone();
