...
mod tests {
    ...
    fn parse_response_error_v1() {
        ...
        assert!(matches!(
            super::parse_response_payload(b"\x01\x00\x00\x00\x00"),
            Err(Error::Server(PqProtoV1Status::SuccessButTruncated))
        ));
