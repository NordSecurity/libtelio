...
impl StatefulFirewall {
    ...
    pub fn enable_tp_lite_stats_collection(
        ...
        // There is a possibility that the callback will be invoked between updating tp_lite_stats_cb
        // and invoking libfw_enable_tp_lite_stats_collection. If the old callback has already been dropped,
        // that would lead to UB. Therefore, we keep the old callback around until libfw has been
        // properly updated.
