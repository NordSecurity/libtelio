...
fn ipv6_blocked() {
    ...
    for TestInput { src1, src2, src3, src4, src5, dst1, dst2, make_udp , is_ipv4} in test_inputs {
        ...
        assert_eq!(fw.process_outbound_packet_sink(&make_peer(), &mut make_udp(src1, dst1)), is_ipv4);
        assert_eq!(fw.process_outbound_packet_sink(&make_peer(), &mut make_udp(src1, dst2)), is_ipv4);
        assert_eq!(fw.process_outbound_packet_sink(&make_peer(), &mut make_udp(src4, dst2)), is_ipv4);
